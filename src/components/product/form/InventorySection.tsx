    ...
    <div className="space-y-6">
      ...
      {!trackInventory && (
        <motion.div 
          ...
          className="p-4 bg-blue-50 border border-blue-100 rounded-xl text-sm text-blue-700 flex items-start gap-3"
        >
          <div className="rounded-full bg-blue-100 p-1.5 mt-0.5">
            <Archive className="h-4 w-4 text-blue-600" />
          </div>
          <div>
            <p className="font-medium mb-1">تم تعطيل تتبع المخزون</p>
            <p>سيكون المنتج متوفراً دائماً بغض النظر عن الكمية المباعة.</p>
          </div>
        </motion.div>
      )}
    </div>
