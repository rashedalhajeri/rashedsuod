...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-900 text-white py-16 rtl">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center gap-2 mb-6">
              <span className="text-3xl font-bold text-primary-400">Linok</span>
              <span className="text-xl font-medium text-gray-400">.me</span>
            </div>
            <p className="text-gray-400 mb-6">
              منصة سعودية تمكّن الأفراد والشركات من إنشاء متاجر إلكترونية بسهولة واحترافية.
            </p>
            <div className="flex space-x-4 rtl:space-x-reverse">
              <a href="#" aria-label="Twitter" className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary-600 transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="#" aria-label="Facebook" className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary-600 transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="h-10 w-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-primary-600 transition-colors">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            <h3 className="text-lg font-bold mb-6">الروابط</h3>
          ...
          <div id="contact">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                <span className="text-primary-500">البريد الإلكتروني:</span>
                <a href="mailto:support@linok.me" className="text-gray-400 hover:text-white transition-colors">support@linok.me</a>
              </li>
              <li className="flex items-center gap-3">
                <span className="text-primary-500">الهاتف:</span>
                <a href="tel:+966558889999" className="text-gray-400 hover:text-white transition-colors">+966 55 888 9999</a>
              </li>
              <li className="flex items-center gap-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">© {new Date().getFullYear()} Linok.me. جميع الحقوق محفوظة.</p>
        </div>
      </div>
    </footer>
  );
