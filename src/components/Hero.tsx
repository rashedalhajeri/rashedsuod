        ...
        <div className={`flex flex-col justify-center ${isRTL ? 'order-1 lg:order-1' : 'order-1 lg:order-0'}`}>
          ...
          >
            <p className="text-xl text-slate-800 font-medium leading-relaxed">
              منصة متجرك الإلكتروني المتكاملة 
              <span className="mx-1 px-2 py-1 bg-primary-50 rounded-lg text-primary-600 font-semibold">بدون عمولة</span> 
              على الطلبات
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-800 font-medium">
              أكثر من <span className="font-bold text-primary-500 text-lg">٧٥٠٠ تاجر</span> 
              <span className="bg-primary-100 px-2 py-1 rounded-lg text-primary-700 text-sm">خلال عام جديد</span>
            </p>
          </motion.div>
        </div>
        ...
        <div className={`flex justify-center items-center relative z-20 ${isRTL ? 'order-0 lg:order-0' : 'order-0 lg:order-1'}`}>
          ...
          >
            ...
            <motion.img 
              ...
              className="w-full h-auto rounded-3xl shadow-2xl relative z-10 object-fill" 
              src="/lovable-uploads/952e8cd7-3a6b-4289-8c3f-b41faa50fcdb.jpg" 
            />
