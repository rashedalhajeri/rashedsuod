...
import { Settings, ShoppingBag, Home, Package, BarChart, Users, Loader2, TrendingUp, Activity, DollarSign, Shield, ArrowRight, Bell } from "lucide-react";
  ...
  if (showCreateStoreDialog) {
    return <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-8 border border-gray-100">
          ...
          <Button onClick={handleCreateStore} className="w-full bg-gradient-to-r from-primary-600 to-primary-500 hover:bg-primary-700">
            إنشاء متجر جديد
          </Button>
        </div>
      </div>;
      ...
      <div className="animate-fade-in space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => window.open(`https://${store?.domain_name}.linok.me`, '_blank')} className="flex items-center gap-2 hover:scale-105 transition-transform duration-300 bg-white border-gray-200">
        ...
        <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab} className="mb-8">
          ...
          <TabsContent value="overview" className="animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white shadow-sm rounded-lg p-6 hover:shadow-md transition-shadow hover:border-primary-200 border border-gray-100 group">
                ...
                <Button className="text-primary-600 font-medium hover:underline bg-transparent group-hover:bg-primary-50 flex items-center" variant="ghost" onClick={() => window.open(`https://${store?.domain_name}.linok.me`, '_blank')}>
                  عرض المتجر
                  <ArrowRight className="mr-1 h-4 w-4 inline-block" />
                </Button>
              </div>
          ...
          <TabsContent value="store" className="animate-fade-in">
            {store && <div className="bg-white shadow-sm rounded-lg p-6 mb-8 border border-gray-100">
