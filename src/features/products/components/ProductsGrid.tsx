...
const ProductsGrid: React.FC<ProductsGridProps> = ({ products, formatCurrency }) => {
              ...
              <div className="absolute inset-0 bg-black/0 hover:bg-black/60 transition-colors flex items-center justify-center opacity-0 hover:opacity-100">
                <div className="flex gap-2">
                  <Button 
                    size="sm" 
                    variant="secondary"
                    onClick={() => toast.info(`عرض المنتج: ${product.name}`)}
                  >
                  ...
                  <Button 
                    size="sm" 
                    variant="secondary"
                    onClick={() => toast.info(`تعديل المنتج: ${product.name}`)}
                  >
              ...
              <div className="flex justify-between items-start">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem 
                      onClick={() => toast.info(`تغيير التصنيف: ${product.name}`)}
                    >
